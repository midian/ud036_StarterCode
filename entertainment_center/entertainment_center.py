...
monsters_inc = media.Movie("Monsters, Inc.",
                        ...
                        " is powered by energy from the screams of human children. ",
                        "http://upload.wikimedia.org/wikipedia/en/6/63/Monsters_Inc.JPG", #NOQA
...
donnie_darko = media.Movie("Donnie Darko",
                        ...
                        " Virginia, troubled teenager Donnie Darko sleepwalks" +
                        " out his house and is woken by a figure in a" +
                        " monstrous rabbit costume.",
                        "http://upload.wikimedia.org/wikipedia/en/d/db/Donnie_Darko_poster.jpg", #NOQA
...
pulp_fiction = media.Movie("Pulp Fiction",
                                ...
                                "http://upload.wikimedia.org/wikipedia/pt/thumb/8/82/Pulp_Fiction_cover.jpg/240px-Pulp_Fiction_cover.jpg",  #NOQA
...
kill_bill = media.Movie("Kill Bill",
                            ...
                            "http:////upload.wikimedia.org/wikipedia/en/thumb/c/cf/Kill_bill_vol_one_ver.jpg/220px-Kill_bill_vol_one_ver.jpg", #NOQA
...
reservoir_dogs = media.Movie("Reservoir Dogs",
                                ...
                                "http://upload.wikimedia.org/wikipedia/en/thumb/f/f6/Reservoir_dogs_ver1.jpg/220px-Reservoir_dogs_ver1.jpg", #NOQA
...
jackie_brown = media.Movie("Jackie Brown",
                                ...
                                "use couriers.",
                                "http://upload.wikimedia.org/wikipedia/en/thumb/8/80/Jackie_Brown70%27s.jpg/220px-Jackie_Brown70%27s.jpg", #NOQA
